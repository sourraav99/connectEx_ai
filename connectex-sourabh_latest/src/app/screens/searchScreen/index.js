...
const Search = ({ props }) => {
  ...
  useEffect(() => {
    ...
    }, 100); // Delay to ensure screen is fully rendered before focusing
      ...
      <View style={{ flex: 1, backgroundColor: COLORS.BLACK_OPACITY(0.38) }}>
        ...
        <View style={{ flexDirection: 'row', width: '98%', alignSelf: 'center', alignItems: 'center', marginTop: verticalScale(10), }}>
          ...
          >
            ...
            <TextInput alue={searchQuery}
        onChangeText={setSearchQuery} cursorColor={COLORS.WHITE} ref={inputRef} placeholderTextColor={COLORS.GREY} style={{fontSize: scale(11),color:colors.white}} placeholder='Find people by name, skills, or industry...'/>
          </View>
          <View
            style={{
              flexDirection: 'row',
